<html class="loaded" lang="en" data-textdirection="ltr" style="--vh: 7.21px;"><!-- BEGIN: Head-->
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin-dashboard/app-assets/css/themes/semi-dark-layout.css')}}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin-dashboard/app-assets/css/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin-dashboard/app-assets/css/core/colors/palette-gradient.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin-dashboard/app-assets/css/pages/authentication.css')}}">
    <!-- END: Page CSS-->
...
<body
    class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page  pace-done"
                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="{{asset('admin-dashboard/app-assets/images/pages/login.png')}}" alt="branding logo">
                            </div>
                                    ...
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form action="{{route('auth.do.login')}}" method="POST">
                                                ...
                                                <button type="submit"
                                                        class="btn btn-block btn-primary float-right btn-inline waves-effect waves-light">
                                                    Login
                                                </button>
                                                <br>
                                                <br>
...
<script src="{{asset('admin-dashboard/app-assets/js/scripts/components.js')}}"></script>
<!-- END: Theme JS-->
